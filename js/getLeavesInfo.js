...
$.start = $.getdata("wzxy_leave_starttime");
$.end = $.getdata("wzxy_leave_endtime");
$.submitTime = $.getdata("wzxy_leave_submitTime");
$.fdycreateTime = $.getdata("wzxy_leave_createTime");
//辅导员
$.teacher = $.getdata("wzxy_leave_teacherName");
//姓名
$.name = $.getdata("wzxy_leave_name");
//假期类型
$.leaveType = $.getdata("wzxy_leave_leaveType");
//紧急联系电话
$.emergency = $.getdata("wzxy_leave_phone");
//reason 请假理由
$.reason = $.getdata("wzxy_leave_reason");
//位置信息
$.leaveLocation = '\"'+$.getdata("wzxy_leave_leaveLocation")+'\"';


yuanjicreateTime=""
xiaojicreateTime=""//销假时间
var time = new Date()
time.setMinutes(0)
if($.start==="" && $.end === ""){
...
body={
  ...
  "data": {
    ...
    "leaves": {
      ...
      "destinationProvince": "",
      "destinationStreet": "",
      "emergencyContact": $.emergency, //手机号
      "endTime": $.end,//结束时间
      "finalTime": $.end,//结束时间
      "gender": "男",
      ...
      "isOut": 2,
      "isOutSchool": 0,
      "leaveLocation": $.leaveLocation, //提交信息时的位置信息
      ...
      "schoolId": "3",
      "status": 40, //40为进行中
      "submitTime": $.submitTime,//提交请假时间
      "teacherId": "471607588888888888",
      "teacherName": $.teacher , //辅导员名称
      "type": 10,
      "userId": "404788888888888888",
      "year": 2022
    },
    "approveList": [{"avatar":"https://thirdwx.qlogo.cn/mmopen/vi_32/mSk0dgt2l7T1fQ8g5icBbhzFP6ic6ibAtd4eQHyy41cBODzib7X5Hg0CptzBZicBLKJzOjGe3OsQibSSpq5uccrphwRA/132",
"createTime":$.submitTime,
"isPass":20,
"level":0,
"name":$.name,
"userId":"219210487043745792",
"userType":"学生"},{
      "avatar": "https://wzxy-img.oss-cn-beijing.aliyuncs.com/leaves_2/static/status/nvlaoshi.png/s", //nvlaoshi.png or nanlaoshi.png
      "college": "建筑工程学院",
      "context": "同意请假",
      "createTime": $.fdycreateTime, //申请通过时间
